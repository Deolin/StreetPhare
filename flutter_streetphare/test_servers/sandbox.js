...
const ALERT_TYPES = [
  ...
  'manifestation', 'zoneSafe', 'panicCollectif', 'autre',
];
 ...
 * Injecte N faux événements de manifestation.
 *
...
<div class="main">
  ...
  <div class="panel">
    ...
    <div class="form-row">
      ...
      <select id="a-type">
        ...
        <option value="manifestation">Groupe casseurs</option>
  ...
  <div class="panel">
    <h2>📅 Injection d'événements de manif</h2>
    <div class="form-row">
