...
class AvoidanceFilters {
  const AvoidanceFilters({
    ...
    this.avoidManifestations = false,
  ...
  /// Ne JAMAIS traverser une zone de manifestation / casseurs.
  final bool avoidManifestations;
  ...
  AvoidanceFilters copyWith({
    ...
    return AvoidanceFilters(
      ...
      avoidManifestations: avoidManifestations ?? this.avoidManifestations,
  ...
  factory AvoidanceFilters.fromJson(Map<String, dynamic> json) {
    return AvoidanceFilters(
      ...
      avoidManifestations: (json['am'] as bool?) ?? false,
